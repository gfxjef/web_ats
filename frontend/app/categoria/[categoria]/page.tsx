      ...
      <div className="p-4">
        {loading ? (
          ...
          <>
            ...
            {/* Botón Cargar Más temporalmente hasta corregir PaginationProgress */}
            {hasMore && (
            ...
            {/* Controles de paginación (solo para desarrollo/demo) */}
              ...
              <div className="mt-4 p-4 bg-gray-100 rounded-lg">
                <div className="flex items-center justify-between text-sm">
                  <div className="space-x-2">
                    <span>Estilo:</span>
                    <Button
                      variant={paginationVariant === 'default' ? 'default' : 'outline'}
                      size="sm"
                      onClick={() => setPaginationVariant('default')}
                    >
                      Default
                    </Button>
                    <Button
                      variant={paginationVariant === 'compact' ? 'default' : 'outline'}
                      size="sm"
                      onClick={() => setPaginationVariant('compact')}
                    >
                      Compact
                    </Button>
                    <Button
                      variant={paginationVariant === 'detailed' ? 'default' : 'outline'}
                      size="sm"
                      onClick={() => setPaginationVariant('detailed')}
                    >
                      Detailed
                    </Button>
                  </div>
                ...
                <div className="mt-2 text-xs text-gray-600">
                  Near bottom: {isNearBottom ? 'Yes' : 'No'} | Progress: {Math.round(progress)}%
                </div>
              </div>
            )}
          </>
